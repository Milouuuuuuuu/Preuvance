 ...
 *
 * `default-src` et `script-src` sont obligatoires : sans eux, la politique ne
 * contraint que le cadrage et les objets, et n'encadre pas le chargement des
 * scripts. Les origines autorisées sont donc énumérées explicitement.
 *
