...
- Toute décision produit, réglementation, IA, données, sécurité ou architecture est inscrite avec une note sur 100 dans le registre de décisions, tenu hors de ce dépôt.
