...
champ. Cas concret résolu : un assistant de développement utilisé par l'équipe
sur ce projet était auparavant affiché « shadow AI critique » ; déclaré avant le
scan, il apparaît désormais comme un usage corroboré, mineur.
...
Conçu et vérifié les 14-16 juillet 2026.
